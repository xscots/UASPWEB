			...
			<div class="row">
				...
				<div class="col-md-4">
					<table class="table">
						...
						<tr>
							<td><a href="delete-proses.php?id='.$id['id'].'" class="btn btn-primary btn-block">Delete</a></td>
							<td style="width:80px"><a href="gallery/'.$row['nama'].'" class="btn btn-primary btn-block">Download</a></td>
						</tr>
					</table>
				</div>
			</div>
